...
levelup: [
  ...
  premium: [
  ["CapCut Pro (1 Month)", "৳99"],
  ["PicsArt Gold (1 Month)", "৳99"],
  ["Remini Pro (1 Month)", "৳99"]
]
};
...
products[current].forEach(item=>{
  ...
  if(current==="premium"){
    if(item[0].includes("CapCut")) image="images/capcut.png";
    if(item[0].includes("PicsArt")) image="images/picsart.png";
    if(item[0].includes("Remini")) image="images/remini.png";
  }
